...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      #screen-academy.gei-academy-lite-screen{
        ...
        box-sizing:border-box!important;background:var(--skin-bg,#f7f9fc)!important;
      ...
      #screen-academy.gei-academy-lite-screen .gei-lite-section-label{
        font-size:10px!important;font-weight:900!important;letter-spacing:.13em!important;color:var(--skin-accent,#007ea3)!important;
      }
      #screen-academy.gei-academy-lite-screen .gei-lite-carousel{
        min-height:0!important;width:100%!important;max-width:100%!important;overflow-x:auto!important;overflow-y:hidden!important;
        display:flex!important;gap:10px!important;scroll-snap-type:x mandatory!important;scrollbar-width:none!important;
        overscroll-behavior-x:contain!important;padding:2px 2px 8px!important;margin:0!important;
      }
      ...
      #screen-academy.gei-academy-lite-screen .gei-lite-card{
        flex:0 0 min(80vw,300px)!important;width:min(80vw,300px)!important;min-height:0!important;height:100%!important;max-height:100%!important;
        scroll-snap-align:center!important;display:grid!important;grid-template-rows:auto auto minmax(0,1fr) auto!important;gap:8px!important;
        padding:15px!important;margin:0!important;border-radius:22px!important;border:1px solid rgba(0,126,163,.24)!important;
      ...
      #screen-academy.gei-academy-lite-screen .gei-lite-status{font-size:8px!important;font-weight:900!important;letter-spacing:.08em!important;padding:5px 7px!important;border-radius:999px!important;background:rgba(0,126,163,.07)!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-icon{display:grid!important;place-items:center!important;width:64px!important;height:64px!important;border-radius:17px!important;background:rgba(0,126,163,.07)!important;font-size:35px!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-card h2{margin:0!important;font-size:clamp(24px,6.8vw,31px)!important;line-height:1.03!important;letter-spacing:-.03em!important;color:var(--skin-text,#102a43)!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-card p{margin:6px 0 0!important;color:var(--skin-muted,#526b82)!important;font-size:13px!important;line-height:1.35!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-card a{display:flex!important;align-items:center!important;justify-content:space-between!important;min-height:46px!important;padding:0 13px!important;border-radius:13px!important;background:var(--skin-accent,#007ea3)!important;color:#fff!important;text-decoration:none!important;font-size:11px!important;font-weight:900!important;letter-spacing:.04em!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-card a.is-locked{background:rgba(16,42,67,.07)!important;color:var(--skin-muted,#526b82)!important;pointer-events:none!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-controls{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:8px!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-arrow{width:44px!important;height:40px!important;border:1px solid rgba(0,126,163,.22)!important;border-radius:12px!important;background:#fff!important;color:var(--skin-text,#102a43)!important;font-size:25px!important;cursor:pointer!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-dots{display:flex!important;justify-content:center!important;gap:6px!important;flex:1!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-dot{width:7px!important;height:7px!important;border-radius:50%!important;background:rgba(16,42,67,.2)!important}
      #screen-academy.gei-academy-lite-screen .gei-lite-dot.is-active{background:var(--skin-accent,#007ea3)!important;transform:scale(1.22)!important}
      @media(max-width:360px){#screen-academy.gei-academy-lite-screen > .gei-lite-root{padding:10px 9px 84px!important}#screen-academy.gei-academy-lite-screen .gei-lite-card{flex-basis:86vw!important;width:86vw!important;padding:13px!important}}
    `;
  ...
  function render() {
      ...
      <div class="gei-lite-root">
        <header class="gei-lite-header">
          ...
          <div class="gei-lite-chip" aria-label="Blueprint progress">
            <strong data-lite-count>0 / 6</strong><small>DAYS</small>
          </div>
        </header>
        <section class="gei-lite-carousel-wrap" aria-label="Six-day celebration cards">
            ...
            ${DAYS.map(day => {
              ...
              return `
                <article class="gei-lite-card${done ? " is-complete" : ""}" data-day="${day.id}">
                  <div class="gei-lite-card-top"><span class="gei-lite-day">DAY ${day.id}</span><span class="gei-lite-status">${done ? "CELEBRATED" : unlocked ? "READY" : "NEXT"}</span></div>
                  <div class="gei-lite-icon" aria-hidden="true">${day.icon}</div>
                  <div><h2>${day.title}</h2><p>${day.desc}</p></div>
                  <a class="${unlocked ? "" : "is-locked"}" href="${day.url}"><span>${done ? "REVISIT DAY " + day.id : unlocked ? "ENTER DAY " + day.id : "LOCKED"}</span><strong>→</strong></a>
                </article>`;
            }).join("")}
          </div>
          <div class="gei-lite-controls" aria-label="Carousel controls">
            ...
            <div class="gei-lite-dots" aria-hidden="true">${DAYS.map((_,i)=>`<span class="gei-lite-dot${i===0?" is-active":""}"></span>`).join("")}</div>
    ...
    screen.querySelectorAll(".gei-lite-arrow").forEach(btn=>btn.addEventListener("click",()=>go(index + Number(btn.dataset.dir))));
    carousel?.addEventListener("scroll",()=>{
      if(!cards.length)return;
      const center=carousel.scrollLeft + carousel.clientWidth/2;
      let closest=0,best=Infinity;
      cards.forEach((card,i)=>{const d=Math.abs(center-(card.offsetLeft+card.offsetWidth/2));if(d<best){best=d;closest=i;}});
      if(closest!==index){index=closest;dots.forEach((dot,i)=>dot.classList.toggle("is-active",i===index));}
    },{passive:true});
